...
const Contact = () => {
  ...
  return (
    <div className="col-12 col-sm-10 col-md-8 mx-auto mt-5">
      <h1 className="titulo-3"> Cuentanos, ¿en que te podemos ayudar? </h1>
      ...
      <Form onSubmit={validarDatos}>
        ...
        <Form.Group className="mb-3">
          <Form.Label className="info">Descripción</Form.Label>
          <Form.Control
            value={descripcion}
        ...
        <Form.Group className="mb-3 boton">
          <Button className="boton" type="submit" variant="danger"> Enviar </Button>
        </Form.Group>
      </Form>
    </div>
  );
